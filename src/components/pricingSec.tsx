      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
        ...
        <div
          className={`relative ${
            isVisible
              ? ""
              : "after:absolute after:inset-x-0 after:bottom-0 after:z-10 after:w-full after:h-48 after:bg-gradient-to-t after:from-white after:via-white/70 dark:after:from-neutral-900 dark:after:via-neutral-900/95"
          }`}
        >
          <div
            ...
            className={`${
              isExpanded
                ? "block lg:block sticky top-0 start-0 py-2 bg-white dark:bg-neutral-900"
                : "hidden lg:block sticky top-0 start-0 py-2 bg-white dark:bg-neutral-900"
            }`}
          >
        ...
        <div className="mt-8 text-center">
          ...
          >
             <span className={isExpanded ? 'hs-collapse-open:hidden' : ''}>
              {isExpanded ? 'Hide features' : 'View features'}
            </span>
            <svg
              className={`transition duration-300 shrink-0 size-4 ${
                isExpanded ? "rotate-180" : ""
              } hidden hs-collapse-open:block group-hover:rotate-180`}
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
